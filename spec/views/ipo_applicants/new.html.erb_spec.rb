...
describe "ipo_applicants/new" do
  before(:each) do
    assign(:ipo_applicant, stub_model(IpoApplicant,
      :production => "MyString",
      :base_unit => "MyString",
      :issue_price => "9.99",
      :total_stock => 1,
  ...
  it "renders new ipo_applicant form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", ipo_applicants_path, "post" do
