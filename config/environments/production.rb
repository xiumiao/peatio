Peatio::Application.configure do
  ...
  config.assets.precompile += %w( funds.js market.js market.css admin.js admin.css html5.js api_v2.css api_v2.js bootstrap-datepicker.css bootstrap-datepicker.min.js  bootstrap-datepicker.zh-CN.min.js .svg .eot .woff .ttf )
